...
/** Skip re-counting the same food on this device within ~6h. */
const VIEW_TTL_MS = 6 * 60 * 60 * 1000;

/**
 * Fires a single POST to increment the food's view count when the detail page
